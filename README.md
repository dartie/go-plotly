...
# Todo
- [ ] Internet connection doesn't need to be a requirement. plotly.js needs to be local
- [ ] Create a method for offline package which returns the html snippet only 
